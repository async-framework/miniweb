# MiniWeb Local Redirect Extension
...
It only redirects top-level page navigations for the MiniWeb preview hostname. It does not redirect every Tailscale URL.
...
[MiniWeb Tailscale preview](https://patrickjs-macbook-pro.lynx-in.ts.net/)

Brave should land on:

[MiniWeb local preview](http://127.0.0.1:5178/)

## Remove

Open `brave://extensions` and remove **MiniWeb Local Redirect**.
