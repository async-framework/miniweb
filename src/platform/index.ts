...
export const caches = globalThis.caches as MiniWebCacheStorage | CacheStorage;
...
export const timers: MiniWebTimers = {
  setTimeout,
  clearTimeout,
  setInterval,
  clearInterval,
...
export const cookies: MiniWebCookieJar = {
  getCookieHeader() {
...
export function getMiniWebPlatform(): Record<string, unknown> {
  return {
    fetch,
    createFetch,
    Request,
...
export function setMiniWebPlatform(): undefined {
  return undefined;
}

export function clearMiniWebPlatform(): void {
  return;
}
